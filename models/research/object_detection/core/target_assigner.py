...
def batch_assign(target_assigner,
  ...
  if not (len(anchors_batch)
    ...
    raise ValueError(f'batch size incompatible with lengths of anchors_batch={anchors_batch}, gt_box_batch={gt_box_batch} and gt_class_targets_batch={gt_class_targets_batch}. ')
  cls_targets_list = []
  cls_weights_list = []
  reg_targets_list = []
  reg_weights_list = []
